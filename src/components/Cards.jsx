...
const Cards = ({ src, cardTitle, cardDesc }) => {
  return (
    <div className="flex flex-col w-full flex-wrap p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
      <img  
        className="w-16 h-16 mb-4 hover:ease-in-out duration-200 hover:transition-all"
        src={src}
        alt="card image"
      ...
      <p className="text-start text-md text-gray-600  sm:pr-4 md:pr-8 lg:pr-12 xl:pr-12 mb-6">
        {cardDesc}
      </p>
